  ...
  const projects = [
    {
      ...
      description: "A full-stack solution with payment integration and real-time inventory management",
    ...
    },
    {
      ...
      description: "Comprehensive component library and design tokens for enterprise applications",
    ...
    },
    {
      ...
      description: "Real-time business intelligence platform with custom data visualizations",
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#e8e8e8]">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl w-full relative z-10">
          <div className="space-y-8">
            ...
            <motion.h1 
              className="text-7xl md:text-9xl font-bold leading-[0.9] tracking-tighter text-glow"
            ...
            <motion.p 
              className="text-xl md:text-3xl text-gray-300 max-w-3xl font-medium leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.button
                ...
                className="group inline-flex items-center gap-2 px-10 py-5 bg-white text-black text-base font-bold uppercase tracking-wider transition-all duration-300 glow-effect"
              ...
              <motion.button
                ...
                className="group inline-flex items-center gap-2 px-10 py-5 border-2 border-white text-white text-base font-bold uppercase tracking-wider transition-all duration-300"
            ...
            {/* Stats */}
            <motion.div 
              className="pt-16 grid grid-cols-3 gap-8 max-w-2xl"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {projects.map((project, index) => {
              const CardContent = () => {
                ...
                return (
                  ...
                  >
                    <motion.div 
                      className="relative overflow-hidden bg-gray-900 aspect-[4/3] mb-6 rounded-lg"
                    ...
                    >
                      ...
                      <motion.div 
                        className="absolute top-6 right-6 w-20 h-20 rounded-full bg-white flex items-center justify-center opacity-0 group-hover:opacity-100 shadow-2xl transition-opacity duration-300"
                      >
                        <span className="text-3xl font-black text-black">0{index + 1}</span>
                      </motion.div>
                    </motion.div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-5xl md:text-7xl font-black leading-tight mb-8 tracking-tight text-white">
                BUILDING AT THE
                <br />
            ...
            >
              <p className="text-2xl text-gray-200 leading-relaxed font-semibold">
                I'm a <span className="text-white font-bold">full-stack developer</span> and <span className="text-white font-bold">designer</span> with a passion for creating thoughtful digital experiences.
              </p>
              <p className="text-xl text-gray-300 leading-relaxed font-medium">
                With 5+ years of experience, I've worked with startups and established companies to bring their visions to life through <span className="font-bold text-white">clean code</span> and <span className="font-bold text-white">intentional design</span>.
              </p>

              {/* Expertise Cards */}
              <div className="grid grid-cols-2 gap-4 pt-8">
                {[
                  { icon: Code, title: 'Development', desc: 'Full-stack expertise' },
              ...
              <div className="pt-8 space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {['React', 'Next.js', 'TypeScript', 'Node.js', 'Python', 'Figma', 'UI/UX Design', 'PostgreSQL'].map((skill, i) => (
                      <motion.span 
                        key={skill} 
      ...
      <section id="contact" className="py-20 px-6 relative overflow-hidden">
        ...
        >
          ...
          <motion.h2 
            className="text-6xl md:text-9xl font-black leading-tight mb-12 tracking-tighter text-white"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.2 }}
